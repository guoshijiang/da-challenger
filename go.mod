module github.com/Layr-Labs/datalayr/middleware/rollup-example/challenger
...
replace github.com/Layr-Labs/datalayr/middleware/rollup-example/bindings => ./common/BVM_EigenDataLayrChain
replace (
